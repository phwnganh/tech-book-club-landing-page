            ...
            <div className={"flex flex-col gap-6 sm:gap-10 md:gap-16 "}>
                ...
                <div className={"grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 items-center"}>
                    {MEMBERSHIP_PRICE_OPTIONS.map((option, index) => {
                        const isSecondIndex = index === option[1]
                        ...
                        <div key={index} className={`rounded-lg border border-neutral-200 p-6 flex flex-col gap-8 ${isSecondIndex ? "shrink-0" : "shrink-0"}`}>
                            <div className={"flex flex-col gap-6 w-full"}>
                                ...
                                <div className={"flex items-center gap-2"}>
                                    <p className={"text-neutral-900 text-preset-3-mobile-font-size sm:text-preset-3-font-size font-preset-3-font-family font-preset-3-font-weight leading-preset-3-line-height tracking-preset-3-letter-spacing"}>{option.price}</p>
